...
- `MNIST_double_descent/`: Contains MNIST experiments for studying the double descent phenomenon across different neural network widths. This folder is adapted from the original PyTorch implementation by Songwei Ge:
